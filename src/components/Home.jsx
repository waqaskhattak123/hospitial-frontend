...
const Home = () => {
  ...
  return (
    <div>
      <Navbar/>
        ...
        <div className="w-auto flex-shrink-0 flex-nowrap mt-4 md:w-[500px]  lg:w-[500px] xl:w-[600px]">
          <h1 className="text-center font-black text-xl leading-10 font-serif md:text-3xl md:font-bold md:mt-[70px] md:mb-5 lg:inline-flex lg:text-[50px] lg:leading-10">We help people to get appointment in online</h1>
      ...
      {/* BG Charackter ended*/}
          {/* main div */}
          <div className="md:grid md:grid-cols-2 md:mt-[100px] lg:mx-20 ">
        <div>
      ...
      {/* our Doctors Cards Ended 4 */}
          ...
          <h1 className="font-serif text-2xl font-semibold text-center mt-3">Send Us a Message</h1>
   <div className='flex flex-row mx-[300px]'>
     ...
     {/* sene us messsage */}
        {/* cards started */}
      <div className="w-full max-w-sm bg-white border mx-[30px] border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div className="flex justify-end px-4 pt-4">
          <button
            id="dropdownButton"
            data-dropdown-toggle="dropdown"
