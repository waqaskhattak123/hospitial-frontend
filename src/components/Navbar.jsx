...
const Navbar = () => {
  return (
    <div>
      ...
      <div className="">
        {/* navbar Div */}
        <div className="flex flex-row w-[100%] h-[50px] mt-0 fixed bg-white">
          {/* logo */}
          {/* Bars  */}
          ...
          <Link to={"/"}>
            <span className="font-black shadow-sm mt-2 cursor-pointer">
              Basic Health Care
            </span>
          </Link>
          <div className="mx-auto mt-2 hidden sm:block sm:flex-nowrap sm:flex-shrink-0 ">
            ...
            <Link to={"/register"}>
              <button className="font-black mx-4 ">CheckUp Now</button>
            </Link>
            <Link to={"/about"}>
            ...
            <Link to={"/contact"}>
              <button className="font-black mx-4 ">Contact a Doctor</button>
            </Link>
            <Link to={"/store"}>
              <button className="font-black mx-4 ">Pharmacy</button>
            </Link>
          </div>
